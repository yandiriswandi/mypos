           ...
           <div class="row">
               <div class="col-md-4 col-md-offset-4">
                   ...
                   <form action="<?=site_url('customer/process')?>" method="post">
                       ...
                       <div class="form-group">
                           <label>Gender *</label>
                           <select name="gender" class="form-control" required><?=$row->description?>
                                <option value="">- Pilih -</option>
                                <option value="L" <?=$row->gender == 'L' ? 'selected' : ''//sama dengan null atau kosong ?>>Laki-laki</option>
                                <option value="P" <?=$row->gender == 'P' ? 'selected' : ''//sama dengan null atau kosong ?>>Perempuan</option>
                           </select>
                       </div>
                       <div class="form-group">
                           <label>Phone *</label>
